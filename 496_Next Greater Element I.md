...
<a href = "https://leetcode.com/submissions/detail/573505693/">58%</a>
``` c++
#include <vector>
#include <iostream>
...
``` 
一樣的做法,只是先儲存sol,在填入ans,比較快

<a href = "https://leetcode.com/problems/next-greater-element-i/submissions/">93.23%</a>
